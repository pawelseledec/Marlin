...
#define STRING_CONFIG_H_AUTHOR "PAWELSEL"               // Who made the changes.
...
// Set to "true" if you have endstop with 3 wires (Vcc, Gnd, Signal) and led.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 887 }
